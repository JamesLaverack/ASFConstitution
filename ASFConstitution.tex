...
\begin{enumerate}
  ...
  \item The \proposeddel{President} \proposedadd{Brigade Chief} of the Committee shall be a full member of the Union.
  ...
  \begin{enumerate}
    \item \textbf{\proposeddel{President} \proposedadd{Brigade Chief}} - Responsible for General Running of the society, including arrangements for fresh and the guide entry
    \item \textbf{\proposeddel{Vice-President} \proposedadd{Rear Admiral}} - Responsible for assisting the \proposeddel{President} \proposedadd{Brigade Chief} and sourcing new anime, manga and Sci-Fi
    \item \textbf{\proposeddel{Treasurer} \proposedadd{Soldier of Fortune}} - Responsible for organising the society finances, budgeting for events and room bookings
    \item \textbf{\proposeddel{Secretary} \proposedadd{Librarian}} - Responsible for society administration, contacting society members though E-Mail to announce meetings and events, managing the Mailing List, taking minutes at General Meetings and managing other forms of communication with the society (such as a Facebook group)
    \item \textbf{\proposeddel{Conventions Officer} \proposedadd{Watcher}} - Responsible for organising trips to Anime or Science Fiction conventions.
  \end{enumerate}
\end{enumerate}

\section{Financial}
\begin{enumerate}
  \item The \proposeddel{Treasurer} \proposedadd{Soldier of Fortune} of the society shall be a full member of the Union and not in their final year at the University. However, if given approval by the UBU Societies Officer a final year student may take the position.
...
\begin{enumerate}
  ...
  \item After the AGM the \proposeddel{President} \proposedadd{Brigade Chief} or \proposeddel{Secretary} \proposedadd{Librarian} must submit a sheet of contact details for the new committee to the UBU Societies Officer as soon as possible.
